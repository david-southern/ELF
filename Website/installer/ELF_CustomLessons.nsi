...
Section "Core Files"
    ...
    SetOutPath "$INSTDIR\Full Lessons"
    File "full_lessons\*.pdf"
...
InstallFonts:
    ...
    CreateShortcut "$DESKTOP\ELF Full Lessons.lnk" "$INSTDIR\Full Lessons"
    CreateShortCut "$SMPROGRAMS\ELF\ELF Full Lessons.lnk" "$INSTDIR\Full Lessons"
...
Section "Uninstall"
    ...
    Delete /REBOOTOK "$INSTDIR\Full Lessons\*.pdf"
    RMDir /REBOOTOK "$INSTDIR\Full Lessons"

    Delete /REBOOTOK "$SMPROGRAMS\ELF\ELF Full Lessons.lnk" 
    Delete /REBOOTOK "$DESKTOP\ELF Full Lessons.lnk"
